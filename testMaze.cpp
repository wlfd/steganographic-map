...
TEST_CASE("treasureMap::basic no cycles", "[weight=1][part=treasureMap]")
{
	...
	treasure.writeToFile("images/studentembeddedsnake.png");
    PNG treasureans;
    treasureans.readFromFile("images/embeddedsnake.png");
    REQUIRE( treasure == treasureans );

    PNG treasuremaze = M.renderMaze();
	treasuremaze.writeToFile("images/studentgreyedsnake.png");
    PNG treasuremazeans;
    ...
    soln.writeToFile("images/studentsolnsnake.png");
    PNG solnans;
    solnans.readFromFile("images/solnsnake.png");
    REQUIRE( soln == solnans );

    PNG solnmaze = dec.renderMaze();
    solnmaze.writeToFile("images/studentsolnsnakemaze.png");
    PNG solnmazeans;
...
TEST_CASE("decoder::basic cycles", "[weight=1][part=decoder]")
{
    ...
    PNG treasure = M.renderMap();
	treasure.writeToFile("images/studentembeddedmaze.png");
    PNG treasureans;
    treasureans.readFromFile("images/embeddedmaze.png");
    REQUIRE( treasure == treasureans );

    PNG treasuremaze = M.renderMaze();
	treasuremaze.writeToFile("images/studentgreyedmaze.png");
    PNG treasuremazeans;
    ...
    PNG soln = dec.renderSolution();
    soln.writeToFile("images/studentsolnmaze.png");
    PNG solnans;
    solnans.readFromFile("images/solnmaze.png");
    REQUIRE( soln == solnans );

    PNG solnmaze = dec.renderMaze();
    solnmaze.writeToFile("images/studentsolnmazemaze.png");
    PNG solnmazeans;
